...
typedef enum {
    ...
    TR_UI_TRADE_YEAR_PREVIOUS,
    TR_UI_TRADE_YEAR_NEXT,
    TR_UI_TRADE_YEAR_NO_EARLIER,
    TR_UI_TRADE_YEAR_CURRENT_LIMIT,
    TR_UI_TRADE_YEAR_CURRENT,
    TR_UI_TRADE_YEAR_LAST,
    TR_UI_TRADE_YEAR_YEARS_AGO,
