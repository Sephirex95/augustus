...
typedef enum {
    ...
    TR_SORT_BUTTON_TRADE_SIDEBAR,
    TR_SORTING_BUTTON_TRADE_SIDEBAR_SORT_BY_NAME,
    TR_SORTING_BUTTON_TRADE_SIDEBAR_SORT_BY_PRICE,
    TR_FILTER_BUTTON_TRADE_SIDEBAR,
    TR_FILTER_BUTTON_TRADE_SIDEBAR_FILTER_BY_OPEN,
    TR_FILTER_BUTTON_TRADE_SIDEBAR_FILTER_BY_RESOURCE,
    TRANSLATION_MAX_KEY
} translation_key;
